...
OPTION( drupcolorpropagate,0,  0,  1,0,0,0, "prefer core in propagation during trim") \
OPTION( drupdumpcore,      0,  0,  1,0,0,0, "dump core clauses") \
OPTION( drupprefercore,    0,  0,  1,0,0,0, "prefer core in propagation during trim") \
